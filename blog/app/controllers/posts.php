<?php
// Najpierw dołącz plik path.php, aby zdefiniować ROOT_PATH
include("../../path.php"); 
            ...
            <?php foreach($posts as $post): ?>
                ...
                <div class="post clearfix">
                    ...
                    <div class="post-preview">
                        <h3><a href="<?php echo BASE_URL . '/single.php?id=' . $post['id']; ?>"><?php echo $post['title']; ?></a></h3>
                        <p class="preview-text">
                            <?php echo html_entity_decode(substr($post['body'], 0, 150) . '...'); ?>
                        </p>
                        <a href="single.php?id=<?php echo BASE_URL . '/single.php?id=' . $post['id']; ?>" class="btn read-more">Zobacz przepis</a>
                    </div>
                </div>
